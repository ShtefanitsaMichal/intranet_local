  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light left fixed-left">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="media/gimmp.png" alt="test" align="center" style="max-width: 40px;">
        </a>
    ...
    <div class="row">
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="#dev_team" data-toggle="tab">Development team applications</a></li>
          <li><a href="#sme_apps" data-toggle="tab">SME Applications</a></li>
        </ul>
                ...
                <div class="col-12 text-center">
                  <h3 class="section-subheading text-muted">Main resources / Główne zasoby</h3>
                    ...
                    <div class="col-md-3 col-sm-6 portfolio-item">
                      <a class="portfolio-link" align="middle" href="http://srvsmp0025/strona_startowa/" target="_blank">
          ...
          <div class="col-md-3 col-sm-6 portfolio-item">
            <a class="portfolio-link" align="middle" href="http://www.sandensmp.pl" target="_blank">
              ...
              <div class="portfolio-caption">
                  <img class="img-fluid" src="media/gimmp.png" style="height:50px;" alt="">
                   <p class="text-muted">SMP website</p>
              </div>
            </a>
          </div>
          ...
          <div class="col-md-3 col-sm-6 portfolio-item">
            <a class="portfolio-link" align="middle" href="https://borg.wolterskluwer.pl/">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <p>LEX - Wolters Kluwer</p>
                </div>
              </div>
              
              <div class="portfolio-caption">
                  <img class="img-fluid" src="media/wolters1.png" style="height:50px;" alt="">
                <p class="text-muted">LEX</p>
              </div>
            </a>
          </div>
          ...
          <div class="col-md-3 col-sm-6 portfolio-item">
            <a class="portfolio-link"  href="https://www.gotomeeting.com/">
              ...
              <div class="portfolio-caption">
                  <img class="img-fluid" src="media/gotomeeting.png" style="height:50px;" alt="">
              <p class="text-muted">Go to Meeting</p>
            </div>
            </a>
          </div>
          ...
          <a class="portfolio-link" href="http://ncpwabp002.aaa.zu1.nec.co.jp:50000/irj/portal">
            <div class="portfolio-hover">
              <div align="middle" class="portfolio-hover-content">
                <p>G-Accounting System</p>
              </div>
            </div>
            <div class="portfolio-caption">
              <img class="img-fluid" src="media/SAP-Logo.png" style="height:50px;" alt="">
              <p class="text-muted">SAP</p>
            </div>
          </a>
        </div>
         <!-- END SAP-->
      ...
      <!--End Second row-->                 
          ...
          <div class="col-md-3 col-sm-5 portfolio-item">
            <a class="portfolio-link" align="middle" href="https://hr.sandensmp.pl/AssecoHR/">
              ...
              <div class="portfolio-caption">
                <img class="img-fluid" src="media/asseco.png"style="height:30px;" alt="">
                <p class="text-muted" align="middle"> Asseco</p>
              </div>
            </a>
          </div>
          <!--/Asseco-->
          ...
          <div class="col-md-3 col-sm-5 portfolio-item">
            <a class="portfolio-link" align="middle" href="http://172.20.1.41:13014">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <p>Sanden Vision HVAC</p>
                </div>
              </div>
              <div class="portfolio-caption">
                <img class="img-fluid" src="media/gimmp.png" style="height:50px;" alt="">
                <p class="text-muted" style="padding-top: -20px; margin-top: -10px;" >Sanden Vision HVAC</p>
              </div>
            </a>
          </div>
          <!--/Sanden vision HVAC-->
       ...
       <!-- END Fourth row-->                 
			...
			<div class="tab-pane" id="dev_team"> 
				<div class="">
					<div class="row">
            <div class="col-12 text-center">
          ...
          <div class="col-md-3 col-sm-6 portfolio-item">
            <a class="portfolio-link" align="middle" href="https://share.sandensmp.pl/pydio/">
              ...
              <div class="portfolio-caption">
                <img class="img-fluid" src="media/pydio.png" style="height:50px;" alt="">
                <p class="text-muted">Share SMP</p>
              </div>
            </a>
          </div>
          <!--/SMP Share-->
          ...
          <div class="col-md-3 col-sm-6 portfolio-item">
            <a class="portfolio-link" align="middle" href="http://srvsmp0025/invrng/">
              ...
              <div class="portfolio-caption">
                <img class="img-fluid" src="media/dataview.png" style="height: 50px;" alt="">
                <p class="text-muted">Inventory Range</p>
              </div>
            </a>
          </div>
          <!--/Inventory Range-->
    ...
    <footer class="fixed-bottom">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              <li class="list-inline-item"  data-toggle="modal" data-target="#myModalIT">
                <a href="#">
                  <i class="fa fa-laptop"></i>
                </a>
              </li>
              <li class="list-inline-item"  data-toggle="modal" data-target="#myModalBudynek">
                <a href="#">
	  ...
	  <a  href="file://172.20.1.30/qms$/01%20QMS_SMP/SMP_QMS.html" target="_blank">
    </footer>
     ...
     <!-- Modal IT HELPDESK -->
      ...
      <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="modal-footer ">
              <a class="portfolio-link" align="middle" href="http://budynek/building/front/helpdesk.public.php" target="_blank"> Zgłoś Ticket </a>
              <button type="button" class="btn btn-default" data-dismiss="modal">Zamknij</button>
            </div>
          </div>
      </div>
...
var imieniny = ("<b>  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;    Dzisiaj jest:</b> " + tyg + ", " + dn + " " + miech + ", " + rok + " roku." + "" +
    "<b> Imieniny:</b> " + im + ".");
document.getElementById("imieniny").innerHTML =
    imieniny; 
</script>
</html>